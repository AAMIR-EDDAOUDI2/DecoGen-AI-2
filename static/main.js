...
'hero.cta': 'Start Designing', 'auth.signin': 'Sign In', 'auth.signout': 'Sign Out',
...
'generate.submit': 'Generate Design', 'generate.viewsaved': 'View My Saved Designs',
...
'reviews.formTitle': 'Leave a Review', 'reviews.namePlaceholder': 'Your name',
'reviews.commentPlaceholder': 'Share your experience…',
'reviews.submit': 'Submit Review', 'reviews.empty': 'No reviews yet — be the first!',
'voice.listening': 'Listening…', 'voice.use': 'Use This', 'voice.cancel': 'Cancel',
},
fr: {
'nav.home': 'Accueil', 'nav.design': 'Créer', 'nav.gallery': 'Galerie',
'nav.about': 'À propos', 'nav.reviews': 'Avis', 'nav.designs': 'Mes designs',
...
'hero.cta': 'Commencer', 'auth.signin': 'Se connecter', 'auth.signout': 'Déconnexion',
...
'generate.submit': 'Générer le design', 'generate.viewsaved': 'Voir mes designs sauvegardés',
'pill.modern': 'Moderne',
...
'reviews.formTitle': 'Laisser un avis', 'reviews.namePlaceholder': 'Votre nom',
'reviews.commentPlaceholder': 'Partagez votre expérience…',
'reviews.submit': 'Soumettre', 'reviews.empty': "Aucun avis pour l'instant — soyez le premier !",
'voice.listening': 'Écoute…', 'voice.use': 'Utiliser', 'voice.cancel': 'Annuler',
},
ar: {
'nav.home': 'الرئيسية', 'nav.design': 'تصميم الغرفة', 'nav.gallery': 'المعرض',
'nav.about': 'حول', 'nav.reviews': 'التقييمات', 'nav.designs': 'تصاميمي',
...
'hero.cta': 'ابدأ التصميم', 'auth.signin': 'تسجيل الدخول', 'auth.signout': 'تسجيل الخروج',
...
'generate.submit': 'توليد التصميم', 'generate.viewsaved': 'عرض تصاميمي المحفوظة',
'pill.modern': 'عصري',
...
'reviews.formTitle': 'اترك تقييماً', 'reviews.namePlaceholder': 'اسمك',
'reviews.commentPlaceholder': 'شاركنا تجربتك…',
'reviews.submit': 'إرسال التقييم', 'reviews.empty': 'لا توجد تقييمات بعد — كن الأول!',
'voice.listening': 'جارٍ الاستماع…', 'voice.use': 'استخدم هذا', 'voice.cancel': 'إلغاء',
},
};
...
(function () {
  ...
  form.addEventListener('submit', async e => {
    ...
    try {
      ...
      pollStatus(data.jobid, `/before/${data.jobid}`);
    } catch (err) {
...
(function () {
  ...
  function renderReviews(reviews) {
    ...
    reviews.forEach(r => {
      ...
      card.innerHTML = `<div class="review-header"><span class="review-name">${escapeHtml(r.name)}</span><span class="review-stars">${stars}</span></div><p class="review-comment">${escapeHtml(r.comment)}</p><span class="review-date">${date}</span>`;
